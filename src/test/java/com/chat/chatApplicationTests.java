...
class chatApplicationTests {
    ...
    void generator() {
        // 数据库连接
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/chat_sms?useSSL=false&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai",
                "root",
                "200202")
                // 全局配置
                .globalConfig(builder -> {
                    builder.author("LZ") // 设置作者【会生成到注释中】
                ...
                .packageConfig(builder -> {
                    builder.parent("com.lz") // 设置父包名
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "src\\main\\resources\\com\\lz\\mapper")); // 设置mapperXml生成路径
                })
                .strategyConfig(builder -> {
                    builder
                            .enableSkipView() // 跳过视图【前后端分离就不需要使用视图】
                            .addInclude("friends","message","users") // 设置需要生成的表名
